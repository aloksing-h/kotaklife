...
const embedDirectVideo = (url, autoplay) => {
  ...
  // const embedHTML = `<div style="left: 0; width: 100%; height: 0; position: relative;
  //  padding-bottom: 56.25%;">
  //     <video src="${url.href}" style="border: 0; top: 0; left: 0; width: 100%; height:
  //  100%; position: absolute; background-color: #000;"
