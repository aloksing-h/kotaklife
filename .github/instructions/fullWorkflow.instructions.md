---
description: "Use for the full AEM Edge Delivery Services end-to-end workflow: Figma design analysis, frontend block implementation, AEM content authoring, GA4 event tracking, and Docusaurus documentation. Covers working directory rules, environment reference, and mandatory STOP gates per phase."
---
...
| Docusaurus: include GA4 events | Each block's MDX must list which GA4 events fire on it |# AEM EDS — Full End-to-End Workflow (Single Prompt)
